...
/**********/
		...
		getFile_i18n : function () {
			...
			//alert($.rup.WAR_NAME  + ".i18n_" + $.rup.lang + ".json");
			$.rup_ajax({
				...
				success: function(data){
			  	...
			  	error: function(XMLHttpRequest, textStatus, errorThrown){
			  			alert("Se ha producido un error en el parseo del fichero JSON de literales de la aplicación => "+textStatus+".\n\n"+"Error devuelto:\n"+textStatus+": "+XMLHttpRequest.status+" - "+XMLHttpRequest.statusText+"errorThrown:"+errorThrown);
			  			/* TODO: AMAIA. QUITAR PARA SUBIR A DESA. ODEI*/
			  			/*$.rup_ajax({
		  					url: $.rup.APP_STATICS + "/resources/" + $.rup.WAR_NAME  + ".i18n_" + $.rup.lang + ".json",			  					
		  					type:'GET', 
		  					dataType: 'html',
