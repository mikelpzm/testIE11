...
//			$.extend(postData, form2object(t[0].prop.searchForm[0])); //Solo se envian los campos que tienen valor y sean diferentes a ""
			...
			// GONTZAL: Le pongo un if porque no consigo hacerlo funcionar correctamente y no quiero romper nada.
			if (typeof prop.searchForm[0] === 'undefined') {
				$.extend(postData, $.rup_utils.unnestjson(form2object(prop.searchForm)));
			} else {
